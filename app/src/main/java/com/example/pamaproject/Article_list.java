...
//        }
//
//        String[] columns = new String[]{"Article_Name","Article_text"};
//        Cursor cursor = db.query("ArticleTable",columns,null,null,null,null,null);
//        String[] header = new String[]{"Article_Name","Article_text"};
//        int[] layout = new int[]{android.R.id.text1, android.R.id.text2};
//        adapter = new ArrayAdapter(this, android.R.layout.two_line_list_item,cursor,header,layout);
//        listView.setAdapter(adapter);

        Cursor cs = null;
        try {
            String[] getcols = {"Article_ID", "Article_Name", "Article_text"};//0,1,2
            cs = db.query("ArticleTable", getcols, "name = ?", null, null, null, null, null);
            if (cs.moveToFirst()){
                //layout
                ...
                SimpleCursorAdapter adapter = new SimpleCursorAdapter(this,db_layout,cs,from,to,0);
                ...
                Toast.makeText(this, "データがねえ", Toast.LENGTH_SHORT).show();
            }
