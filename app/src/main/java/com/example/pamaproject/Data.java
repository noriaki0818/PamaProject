...
public class Data {
    ...
    protected int Sleep_ID;
    protected int Bodyhealth_ID;
    protected int Hospital_ID;
    protected int Excretion_ID;
    protected int Code;
    ...
    //    病院テーブル
    protected int medicin;
    protected int preventional;
    protected int hospital;
    protected int lnjury;
    protected int rash;
    protected int vomit;
    protected int cough;
